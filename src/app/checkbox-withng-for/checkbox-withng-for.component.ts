...
@Component({
  selector: 'app-checkbox-withng-for',
  templateUrl: './checkbox-withng-for.component.html',
  styleUrls: ['./checkbox-withng-for.component.css'],
})
export class CheckboxWithngForComponent implements OnInit {
  dataSet: any[] = [];
